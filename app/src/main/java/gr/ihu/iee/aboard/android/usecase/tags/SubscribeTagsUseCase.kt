...
package gr.ihu.iee.aboard.android.usecase.tags
...
class SubscribeTagsUseCase @Inject constructor(
    private val dataSource: TagsDataSource
) {

    suspend operator fun invoke(tagsBody: TagsBody) {
        dataSource.subscribeTags(tagsBody)
    }
}