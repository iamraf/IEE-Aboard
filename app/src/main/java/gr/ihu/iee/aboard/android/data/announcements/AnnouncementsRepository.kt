...
interface AnnouncementsRepository {
    ...
    suspend fun fetchPagingAnnouncements(page: Int): RemoteAnnouncementsResponse

    suspend fun fetchPagingSearch(page: Int, query: String): RemoteAnnouncementsResponse

    suspend fun fetchAnnouncement(id: String): RemoteAnnouncementResponse
}