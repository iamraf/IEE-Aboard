...
package gr.ihu.iee.aboard.android.usecase.notifications
...
class FetchNotificationsUseCase @Inject constructor(
    ...
    suspend operator fun invoke(page: Int): List<Notification> {
        return dataSource.fetchPagingNotifications(page)
    }
}