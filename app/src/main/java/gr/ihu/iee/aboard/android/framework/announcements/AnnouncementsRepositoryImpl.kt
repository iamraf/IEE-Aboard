...
class AnnouncementsRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchPagingAnnouncements(page: Int): RemoteAnnouncementsResponse = apiCall {
        api.fetchPagingAnnouncements(page)
    }

    override suspend fun fetchPagingSearch(page: Int, query: String): RemoteAnnouncementsResponse = apiCall {
        api.fetchPagingSearch(page, query)
    }

    override suspend fun fetchAnnouncement(id: String): RemoteAnnouncementResponse = apiCall {
        api.fetchAnnouncement(id)
    }
}